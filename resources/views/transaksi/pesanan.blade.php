...
@section('script')
    <script>
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $.each(res, function(i, data) {
                        ...
                        <td>
                          <button class="btn ` + btn_color + ` btn-sm container" onClick="changeStatus(` + data.id +
                            `,` + to_status + `)" title="Status Transaksi!">
                                ` + data.status + `
                          </button>
                        </td>
                        <td>
        ...
        function detailData(id) {
            var _url = "{{ route('pesanan.detail', ':id') }}"
        ...
        function changeStatus(id, toStatus) {
            Swal.fire({
                    title: "Apakah anda yakin ingin melakukan konfirmasi pada pesanan ini?",
                    icon: "warning",
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        var _url = "{{ route('pesanan.status.change', [':id', ':to_status']) }}";
                        _url = _url.replace(':id', id);
